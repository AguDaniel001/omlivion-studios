        ...
        <div className=" px-20 h-20 flex items-center justify-between">
          <Link href="/" className="relative flex items-center h-10">
            ...
            <div ref={logoIconRef} className="flex items-center">
              <svg width="40" height="40" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M24.5 0C38.031 0 49 10.969 49 24.5C49 38.031 38.031 49 24.5 49C10.969 49 0 38.031 0 24.5C0 10.969 10.969 0 24.5 0ZM24.5 3C12.6259 3 3 12.6259 3 24.5C3 36.3741 12.6259 46 24.5 46C36.3741 46 46 36.3741 46 24.5C46 12.6259 36.3741 3 24.5 3ZM25.0225 30.4062L31.1582 17H35L26.1865 36H23.791L15 17H18.8418L25.0225 30.4062Z" fill="white"/>
              </svg>
            </div>
          </Link>
          ...
          <div className="flex justify-end items-center">
            ...
            <button
              ...
              className=" z-[120] group flex items-center justify-center w-12 h-12 rounded-full bg-white hover:bg-gray-200 transition-transform active:scale-95"
            >
              <div className="relative flex flex-col items-center justify-center w-6 gap-1.5 z-10">
                ...
                <span className={`block w-full h-0.5 bg-black transition-all duration-300 ${isOpen ? "opacity-0" : "opacity-100"}`} />
                <span className={`block w-full h-0.5 bg-black transition-all duration-300 ${isOpen ? "-rotate-45 -translate-y-2" : ""}`} />
              </div>
