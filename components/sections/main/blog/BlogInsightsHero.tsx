...
interface BlogInsightsHeroSectionProps       {
  overline?: string;
  headline?: string;
  description?: string;
}
...
export default function BlogInsightsHeroSection({
  overline = "Insights",
  headline = "Perspectives on digital and web.",
  description = "Our thoughts on creativity, digital, and branding.",

}: BlogInsightsHeroSectionProps) {
  ...
  return (
    <section data-theme="light" ref={sectionRef} className="relative overflow-hidden bg-white h-[84vh] z-5">
